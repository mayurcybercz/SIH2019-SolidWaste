...
$sql="INSERT INTO midadmindata(admin_firstname,admin_lastname,admin_email,admin_mobile,admin_uid,admin_pwd) VALUES ('$admin_first','$admin_last','$admin_email','$admin_mobile','$admin_uid','$admin_pwd')";
mysqli_query($conn,$sql);

header("Location:/Final/authentication/mid-admin-login.php?signup=success");
exit();
